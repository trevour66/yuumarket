...
include_once "login_file/includes/register.inc.php";
?>
	<div class="row">
		<div class="col-md-12">
			<?php display_message(); ?>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" name="registration_form">
				...
				<div class="form-group">
					<input type="text" name="mobile_number" id="mobile_number" class="form-control input-lg" placeholder="Mobile Number" tabindex="4" required>
				</div>
				<div class="form-group">
					<input type="text" name="Address" id="Address" class="form-control input-lg" placeholder="Address" tabindex="5" required>
				</div>
				<div class="form-group">
					<input type="text" name="second_Address" id="second_Address" class="form-control input-lg" placeholder="Second Address" tabindex="6">
				</div>
				<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-6">
						<div class="form-group">
							<input type="password" name="confirm_password" id="confirm_password" class="form-control input-lg" placeholder="Confirm Password" tabindex="9" required>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<hr class="colorgraph">
				<div class="row">
					<div class="col-xs-12 col-md-6"><input type="submit" name="submit" value="Register" class="btn btn-primary btn-block btn-lg" tabindex="10"></div>
